---
title: "Sobre"
description: "Conheça a equipe editorial do England FUT Market, a origem dos dados e os critérios aplicados às análises de EA FC."
---

O **England FUT Market** é uma publicação editorial especializada em EA FC Ultimate Team. Nosso foco é claro: preços e mercado dos jogadores ingleses no EA FC Ultimate Team, todos os dias.

## Quem assina

As publicações são assinadas por **England FUT Market**. O sistema organiza dados de mercado, produz tabelas e aplica regras editoriais reproduzíveis antes de liberar cada análise. Dúvidas, correções e sugestões podem ser enviadas para [contato@futquant.com](mailto:contato@futquant.com).
